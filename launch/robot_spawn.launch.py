...
def launch_setup(context, *args, **kwargs):
    ...
    group_action_spawn_robot = GroupAction([
        ...
        # Patch robot description
        Node(
            package='jackal_helper',
            executable='jackal_patcher.py',
            namespace=namespace,
            parameters=[
                {'XML_from_topic': 'robot_description',
                'publish_to_topic': 'robot_description_patched'}
            ],
            output='screen'
        ),
        ...
        Node(
            ...
            arguments=['-name', robot_name,
                       ...
                       '-z', z,
                       '-Y', yaw,
                       '-topic', 'robot_description_patched'],
            output='screen'
        ),
    ])
